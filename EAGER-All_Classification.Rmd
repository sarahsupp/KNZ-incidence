...
smammals_graphing <- smammals_class_long %>% dplyr::select(Recyear, Species, Common_name, category, Presence, Watershed_name, Fire_interval, Grazing)
...
smammals_graphing$category <- factor(smammals_graphing$category,
                                        levels = c("No change-always_absent", "No change-always_present", "Increasing", "Recurrent", "Random"))
