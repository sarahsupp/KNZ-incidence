...
# NSF - EAGER: A novel investigation of population and community temporal trajectories leveraging experimental disturbances from the Konza Prairie Long-Term Ecological Research Network site

##Functions
This section is dedicated to the functions that will be applied to datasets. 
...
smammals_long <- pivot_longer(smammals, cols = 8:21, 
                              names_to = "Species", 
                              values_to = "Count")
...
smammals_long <- smammals_long %>% group_by(Recyear, Watershed_name, Species) %>% 
