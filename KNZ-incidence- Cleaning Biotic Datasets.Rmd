...
plant_comp1_wide <- plant_comp1_group %>% pivot_wider(names_from = Genus_spp, values_from = Cover)


plant_comp1_wide2 <- plant_comp1_wide %>% subset(.$WaterShed =! c("FA", "FB", "WA", "WB", "SpA", "SpB", "SuA", "SuB", "R1A", "R1B", "R20A", "R20B", "4F", "20A", "20D", "N2A", "N2B"))
