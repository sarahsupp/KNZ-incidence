...
E1_sm_class <- read_csv("Datasets/E1_output_data/E1_smammals/E1_smammals_classified.csv")
E1_sm_class_abund <-
  read_csv("Datasets/E1_output_data/E1_smammals/E1_smammals_classified_abund.csv")

E1_sm_diss_year1toN <-
  read_csv("Datasets/E1_output_data/E1_smammals/E1_smammals_dissimilarity_year1toN.csv")
E1_sm_diss_watershed <- 
    read_csv("Datasets/E1_output_data/E1_smammals/E1_smammals_dissimilarity_watersheds.csv")

E1_sm_rich <- 
  read_csv("Datasets/E1_output_data/E1_smammals/E1_smammals_richness.csv")
E1_sm_rich_lm <- read_csv("Datasets/E1_output_data/E1_smammals/E1_smammals_richness_lm.csv")

E1_sm_abun <- read.csv("Datasets/E1_output_data/E1_smammals/E1_smammals_abundance.csv")
E1_sm_abun_lm <- read.csv("Datasets/E1_output_data/E1_smammals/E1_smammals_abundance_lm.csv")
...
E1_gh_class_abund <-
  read_csv("Datasets/E1_output_data/E1_grasshoppers/E1_grasshoppers_classified_abund.csv")

E1_gh_diss_year1toN <-
  read_csv("Datasets/E1_output_data/E1_grasshoppers/E1_grasshoppers_dissimilarity_year1toN.csv")
E1_gh_diss_watershed <- 
    read_csv("Datasets/E1_output_data/E1_grasshoppers/E1_grasshoppers_dissimilarity_watersheds.csv")

E1_gh_rich <- 
  read_csv("Datasets/E1_output_data/E1_grasshoppers/E1_grasshoppers_richness.csv")
E1_gh_rich_lm <- read_csv("Datasets/E1_output_data/E1_grasshoppers/E1_grasshoppers_richness_lm.csv")

E1_gh_abun <- read.csv("Datasets/E1_output_data/E1_grasshoppers/E1_grasshoppers_abundance.csv")
E1_gh_abun_lm <- read.csv("Datasets/E1_output_data/E1_grasshoppers/E1_grasshoppers_abundance_lm.csv")
