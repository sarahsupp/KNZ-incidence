...
ggplot(pl_resid, aes(x = Watershed_name, y = classification, fill = Residual)) +
  ...
  scale_fill_gradient2(low = "indianred", mid = "white", high = "navyblue", 
...
ggsave("Figures/class_frequency_by_taxa.png", dpi=300, width=6, height=6)
```
...
ggsave("Figures/class_abun_frequency_by_taxa.png", dpi=300, width=6, height=6)
```
