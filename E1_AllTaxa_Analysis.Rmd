...
bird_classification = process_classify_data(data=E0_birds,
                                            species_col=AOU_code,
                                            count_col=Count,
                       "Datasets/E1_output_data/E1_birds/E1_birds_classified.csv")

plant_classification = process_classify_data(data=E0_plants,
                                             species_col=Genus_spp,
                                             count_col=Cover,
                 "Datasets/E1_output_data/E1_plants/E1_plants_classified.csv")
```
...
#Creating a table with the species.watershed and the getTrends info. 
#I excluded the baseline info. 
#FIXME: ADD INFO ABOUT WHAT THIS IS TAKING FROM 
...
Pivot longer to add back in the pres/abs and year information
```{r}
#Pivoting longer so that each row is now a year, species, watershed, etc.
smammals_classification_long <- smammals_classification %>% 
  pivot_longer(cols = "1992":"2013", names_to = "Recyear", values_to = "Presence")


smammals_classification_summary <- smammals_classification %>% 
...
#FIXME: doesn't work. Use E2_AllTaxa_Plots.Rmd instead
### Plot classification results as a whole
```{r}
ggplot(smammals_classification, aes(classification)) + 
