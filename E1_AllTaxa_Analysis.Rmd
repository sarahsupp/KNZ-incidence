...
Compare all years within a watershed to the baseline year.
Is dissimilarity increasing through time?
Is the rate of composition change different according to treatment?
```{r}
...
#FIXME: add this plot to E2 file instead?
Visualize the results
```{r}
smammals_jacc_allyears_plot <- 
  ggplot(data=smammals_jacc_allyears, aes(x=Year2, y=Jacc_diss)) + 
  geom_point() +
