...
for(i in 1:14){
 ...
 "#F8766D" "#E38900" "#C49A00" "#99A800" "#53B400" "#00BC56" "#00C094" "#00BFC4" "#00B6EB" "#06A4FF"
[11] "#A58AFF" "#DF70F8" "#FB61D7" "#FF66A8"
...
smallmammals_years_wide2 <- smallmammals_years_wide2 %>% mutate(Total_Persistence = 
                                                                rowSums(smallmammals_years_wide2[, 5:37]))
...
smallmammals_years_wide2 <- smallmammals_years_wide2 %>% mutate(Persistence = NA)

for (j in 1:nrow(smallmammals_years_wide2)){
  if(smallmammals_years_wide2[j,3] == "Ungrazed"){smallmammals_years_wide2[j,39]<-(smallmammals_years_wide2[j,38])/33}
  if(smallmammals_years_wide2[j,3] == "Bison"){smallmammals_years_wide2[j,39]<-(smallmammals_years_wide2[j,38])/22}
}
...
smallmammals_halfspecies3 %>% 
  ...
  Abundance_plot2 <- smallmammals_halfspecies4 %>% 
  ggplot(aes(x = Recyear, y = Abundance, group = Species, color = Species)) + 
   scale_color_manual(values = c("#00BFC4", "#00B6EB", "#06A4FF",
                                 "#A58AFF", "#DF70F8", "#FB61D7", 
                                 "#FF66A8")) +
