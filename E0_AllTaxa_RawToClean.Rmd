...
#Check the lengths of the species (the 'species' variable has a lot more entries, but they are duplicates with naming variations when looking at the matching common names. So I'll use the AOU code instead.)
...
birds$AOU_code <- dplyr::recode(birds$AOU_code, "eawp" = "EAWP")
