...
raw_smammals <- read_csv("Datasets/Raw_data/Small_mammals/knb-lter-knz.88.9_FourteenTraplines/CSM011.csv")
...
raw_birds <- read_csv("Datasets/Raw_data/Birds/knb-lter-knz.26.12/CBP011.csv", show_col_types = FALSE)
...
raw_plants <- read_csv("Datasets/Raw_data/Plants/knb-lter-knz.69.21_SpeciesComposition/PVC021.csv")
